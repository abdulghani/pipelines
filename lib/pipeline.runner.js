...
class PipelineRunner {
    ...
    start() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (((_b = (_a = taskParams.azurePipelineType) === null || _a === void 0 ? void 0 : _a.toLowerCase) === null || _b === void 0 ? void 0 : _b.call(_a)) === "release") {
                    core.info(`RUNNIG RELEASE PIPELINE (${pipelineName})`);
                    const release = yield this.RunDesignerPipeline(webApi);
                    yield this.MonitorDeployment(webApi, release);
                }
                else {
    ...
    MonitorDeployment(webApi, release) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield releaseApi.getRelease(projectName, releaseId);
    ...
    RunYamlPipeline(webApi) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (pipeline_helper_1.PipelineHelper.equals(repositoryId, this.repository) &&
            ...
            if (buildQueueResult != null) {
                ...
                if (buildQueueResult.validationResults != null &&
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (gitHubArtifacts == null || gitHubArtifacts.length == 0) {
                ...
                gitHubArtifacts.forEach((gitHubArtifact) => {
                    if (gitHubArtifact.definitionReference != null &&
